...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float node_5610 = 0.2;
                float3 diffColor = float3(node_5610,node_5610,node_5610);
                float specularMonochrome;
                float3 specColor;
